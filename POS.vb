...
Public Class POS
    ...
    Private Sub SetupTooltips()
        ...
        toolTip.SetToolTip(btnProcessPayment, "Process the payment for the current transaction (F3)")
        toolTip.SetToolTip(btnClearcart, "Clear all items and start a new transaction (F2)")
        toolTip.SetToolTip(Button3, "Open payment screen to complete the transaction (F3)")
        toolTip.SetToolTip(Button1, "Apply discount to this transaction (F4)")
        toolTip.SetToolTip(btnCancelOrder, "View today's sales report (F1)")
        ...
        toolTip.SetToolTip(txtAmountPaid, "Enter the amount paid by the customer")
        ...
        toolTip.SetToolTip(shortcutsLabel, "F1: Daily Sales" & vbCrLf &
                                       "F2: New Transaction" & vbCrLf &
                                       "F3: Pay " & vbCrLf &
                                       "F4: Discount Panel" & vbCrLf &
                                       "F5: Exit Panel" & vbCrLf &
    ...
    Protected Overrides Function ProcessCmdKey(ByRef msg As Message, ByVal keyData As Keys) As Boolean
        Select Case keyData
            Case Keys.F1
                btnCancelOrder_Click(Nothing, Nothing) ' Open Daily Sales
                Return True
            Case Keys.F2
                BtnClearCart_Click(Nothing, Nothing) ' Start New Transaction
                Return True
            Case Keys.F3
                Button3_Click(Nothing, Nothing) ' Open Payment Screen
                Return True
            Case Keys.F4
                Button1_Click(Nothing, Nothing) ' Open Discount Panel
                Return True
            Case Keys.F5
                Button8_Click(Nothing, Nothing) ' Exit Sales
                Return True
            Case Keys.Escape
